...
def preprocess_retina(img_bgr, target_size=512):
    ...
    # Green channel gives strongest vessel contrast in fundus images
    ...
    # Convert to 3-channel input (required for U-Net)
...
class VesselUNet(nn.Module):
    def __init__(self):
        ...
        # Convolutional block: (Conv → BN → Conv → BN)
        ...
        # Bottleneck layer (deep representation)
...
if __name__ == "__main__":
    IMG_DIR = r"C:\Users\m12re\ROP\ROP_project\segmentation\images"
    MSK_DIR = r"C:\Users\m12re\ROP\ROP_project\segmentation\masks"
    ...
    for ep in range(1, 51):
        ...
        for x, y in tqdm(tr_loader, desc=f"Epoch {ep}/50"):
            ...
            # Combine BCE and Dice losses for better segmentation performance
